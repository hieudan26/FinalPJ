...
public class SortFilterAndLiveSearchAPI extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<ProductsEntity> productsEntityList
                = SingletonServiceUltils.getProductDAOImpl().getProductWithMoreCondition(flag, categoryId, colorId, tagId, sort, min, max, search, 9, startPos);
        List<ProductsEntity> AllproductsEntityList
                = SingletonServiceUltils.getProductDAOImpl().getProductWithMoreCondition(flag, categoryId, colorId, tagId, sort, min, max, search, 1000, 0);
